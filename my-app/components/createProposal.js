...
export default function CreateProposal() {
  return (
    <section className={`${styles.main} flex flex-col items-center mt-11`}>
      ...
      <section
        className={`my-8 w-1/2 h-96 flex flex-col justify-center py-11 border-l-4 border-t-4 border-r-2 border-b-2 rounded-lg`}
      >
        <form className="w-full">
          <section className="flex flex-col flex-wrap content-center">
            ...
            <section className="w-full md:w-3/4 px-3 mb-6 md:mb-0">
              <label
                className="block uppercase tracking-wide text-gray-200 text-xs font-bold my-2"
            ...
            <section className="w-full md:w-3/4 px-3 mb-6 md:mb-6">
              <label
                className="block uppercase tracking-wide text-gray-200 text-xs font-bold mt-4 mb-2"
                htmlFor="grid-pdf-link"
              >
                Proposal PDF Link
              </label>
              <input
