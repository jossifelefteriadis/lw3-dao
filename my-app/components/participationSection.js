...
const cardsInfo = [
  {
    ...
    description: "Make sure you are signed in with the correct wallet so you can participate with your vote in different proposals"
  },
  {
    id:2,
...
function Cards({title, desc}) {
  return (
    <div className={`my-8 flex flex-col items-center justify-center flex-wrap break-words py-11 border-l-4 border-t-4 border-r-2 border-b-2 rounded-lg`}>
